library = {flags={},items={}};
library.theme = {fontsize=15,titlesize=20,font=Enum.Font.Code,background="rbxassetid://5553946656",tilesize=50,cursor=false,cursorimg="https://t0.rbxcdn.com/42f66da98c40252ee151326a82aab51f",backgroundcolor=Color3.fromRGB(20, 20, 20),tabstextcolor=Color3.fromRGB(240, 240, 240),bordercolor=Color3.fromRGB(60, 60, 60),accentcolor=Color3.fromRGB(74, 50, 163),accentcolor2=Color3.fromRGB(74, 50, 163),outlinecolor=Color3.fromRGB(60, 60, 60),outlinecolor2=Color3.fromRGB(0, 0, 0),sectorcolor=Color3.fromRGB(30, 30, 30),toptextcolor=Color3.fromRGB(74, 50, 163),topheight=48,dpScrollBarThickness=10,topcolor=Color3.fromRGB(30, 30, 30),topcolor2=Color3.fromRGB(15, 15, 15),buttoncolor=Color3.fromRGB(49, 49, 49),buttoncolor2=Color3.fromRGB(39, 39, 39),itemscolor=Color3.fromRGB(200, 200, 200),itemscolor2=Color3.fromRGB(210, 210, 210)};
...
if not game:GetService("CoreGui"):FindFirstChild("Credit") then
	...
	Text.TextColor3 = Color3.fromRGB(74, 50, 163);
	...
	TexT.Size = UDim2.new(1, 0, 1, 0);
	TexT.Font = Enum.Font.PermanentMarker;
	TexT.Text = "DC: VOLKINZ";
	TexT.TextColor3 = Color3.fromRGB(74, 50, 163);
	TexT.TextScaled = true;
	TexT.TextWrapped = true;
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Volkinzs/Evokinz/main/NotificationBase.lua"))();
    wait()
end
return library;
